...
public class ChatController {
    ...
    public String chat(@RequestBody Map<String, String> payload) {
        ...
        parts.add(Map.of("text",
               "你是一個智慧客服助理，負責回答使用者有關訂單管理系統的問題，功能包括：登入、註冊、查詢、新增、修改、刪除訂單等功能，請用中文正確簡單回覆問題，僅回答與問題直接相關的部分並去除英文和無關的字。登入:輸入帳號與密碼即可登入系統。註冊：填寫帳號、密碼與Email建立帳戶。查詢訂單:登入後可查詢訂單。新增訂單:登入後點選新增訂單，填寫商品與數量後送出。修改訂單:於訂單列表點選編輯進行修改。刪除訂單:點選刪除後確認即可移除該筆訂單。"));
